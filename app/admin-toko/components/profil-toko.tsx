...
// Tema warna disamakan dengan Admin Toko Dashboard (amber), bukan hijau seperti punya Produsen.
...
export default function ProfilTokoPage({ open, onClose, onProfileUpdate }: ProfilTokoPageProps) {
  ...
  // Belum ada data toko sama sekali → popup wajib tampil & tidak bisa ditutup sampai diisi,
