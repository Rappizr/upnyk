    ...
    <main style={{ padding: "2rem" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1.5rem", flexWrap: "wrap", gap: "1rem" }}>
        ...
        <div style={{ display: "flex", gap: "0.6rem" }}>
          <button onClick={() => setShowTarikModal(true)} style={{ background: "#2563EB", color: "white", border: "none", padding: "0.625rem 1.25rem", borderRadius: "8px", fontWeight: 600, cursor: "pointer", fontSize: "0.9rem" }}>Tarik Tunai</button>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem", marginBottom: "1.5rem" }}>
        <div style={{ background: "#2563EB", padding: "1.25rem", borderRadius: "12px" }}>
          ...
          <div onClick={(e) => e.stopPropagation()} style={{ background: "white", borderRadius: "14px", padding: "1.5rem", width: "400px", maxWidth: "100%" }}>
            ...
            <form onSubmit={handleTarikSubmit} style={{ display: "flex", flexDirection: "column", gap: "0.9rem" }}>
              ...
              <div style={{ display: "flex", gap: "0.5rem", marginTop: "0.5rem" }}>
                ...
                <button type="submit" style={{ flex: 1, padding: "0.6rem", borderRadius: "8px", border: "none", background: "#2563EB", color: "white", fontWeight: 600, cursor: "pointer" }}>Konfirmasi Penarikan</button>
              </div>
            </form>
          </div>
        </div>
