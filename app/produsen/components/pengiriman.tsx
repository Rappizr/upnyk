  ...
  return (
    <main style={{ padding: "2rem" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1rem", marginBottom: "1.5rem" }}>
        <div onClick={() => setTab("Diproses")} style={{ background: "white", padding: "1.1rem", borderRadius: "12px", border: tab === "Diproses" ? "2px solid #2563EB" : "1px solid #E2E8F0", display: "flex", alignItems: "center", gap: "0.9rem", cursor: "pointer" }}>
        ...
        <div onClick={() => setTab("Dikirim")} style={{ background: "white", padding: "1.1rem", borderRadius: "12px", border: tab === "Dikirim" ? "2px solid #2563EB" : "1px solid #E2E8F0", display: "flex", alignItems: "center", gap: "0.9rem", cursor: "pointer" }}>
        ...
        <div onClick={() => setTab("Selesai")} style={{ background: "white", padding: "1.1rem", borderRadius: "12px", border: tab === "Selesai" ? "2px solid #2563EB" : "1px solid #E2E8F0", display: "flex", alignItems: "center", gap: "0.9rem", cursor: "pointer" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
        {activeList.length === 0 && (
          <div style={{ background: "white", borderRadius: "12px", border: "1px solid #E2E8F0", padding: "2rem", textAlign: "center", color: "#94A3B8" }}>Tidak ada pesanan di tahap ini.</div>
        )}
        {activeList.map((p) => (
          <div key={p.id} style={{ background: "white", borderRadius: "12px", border: "1px solid #E2E8F0", padding: "1.1rem 1.25rem" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
              <div style={{ minWidth: 0, flex: 1 }}>
                ...
                {p.noResi && (
                  <div onClick={() => copyResi(p.noResi!)} style={{ display: "inline-flex", alignItems: "center", gap: "6px", marginTop: "0.5rem", background: "#EFF6FF", color: "#2563EB", fontSize: "0.78rem", fontWeight: 600, padding: "0.3rem 0.6rem", borderRadius: "6px", cursor: "pointer" }}>
                    <IconCopy /> {p.noResi}
                  </div>
                )}
              </div>
              <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem", alignItems: "flex-end" }}>
                {p.status === "Diproses" && <button onClick={() => updatePesananStatus(p.id, "Dikirim")} style={{ background: "#2563EB", color: "white", border: "none", padding: "0.55rem 1rem", borderRadius: "8px", fontWeight: 600, cursor: "pointer", fontSize: "0.85rem" }}>Kirim Sekarang</button>}
