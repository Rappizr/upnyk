...
export default function ProfilUMKM({ profil, setProfil }: Props) {
  ...
  return (
    <main style={{ padding: "1.25rem clamp(1rem, 4vw, 1.75rem)", maxWidth: "640px", boxSizing: "border-box" }}>
      ...
      {!editing ? (
        <div style={{ background: "white", borderRadius: "14px", border: "1px solid #E2E8F0", overflow: "hidden" }}>
          {/* Hero cover */}
          <div style={{ background: "linear-gradient(135deg, #10B981, #059669)", height: "110px", position: "relative" }} />
          <div style={{ padding: "0 1.5rem 1.5rem", marginTop: "-52px" }}>
            <div style={{ display: "flex", alignItems: "flex-end", gap: "1rem", flexWrap: "wrap" }}>
              <div style={{ position: "relative", flexShrink: 0 }}>
                <div style={{ width: "100px", height: "100px", borderRadius: "50%", background: "#ECFDF5", color: "#10B981", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "2rem", fontWeight: 700, border: "4px solid white", overflow: "hidden" }}>
                  {profil.fotoUrl ? <img src={profil.fotoUrl} alt="Foto profil" style={{ width: "100%", height: "100%", objectFit: "cover" }} /> : profil.inisial}
                </div>
                <button onClick={() => fileRef.current?.click()} style={{ position: "absolute", bottom: 0, right: 0, width: "30px", height: "30px", borderRadius: "50%", background: "#10B981", color: "white", border: "3px solid white", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }} aria-label="Ubah foto profil">
                  <IconCamera />
                </button>
          ...
          <div style={{ padding: "0 1.5rem 1.5rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "0.7rem" }}>
              <span style={{ color: "#10B981", background: "#ECFDF5", width: "34px", height: "34px", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center" }}><IconMapPin /></span>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.7rem" }}>
              <span style={{ color: "#10B981", background: "#ECFDF5", width: "34px", height: "34px", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center" }}><IconPhone /></span>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.7rem" }}>
              <span style={{ color: "#10B981", background: "#ECFDF5", width: "34px", height: "34px", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center" }}><IconMail /></span>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.7rem" }}>
              <span style={{ color: "#10B981", background: "#ECFDF5", width: "34px", height: "34px", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center" }}><IconUser /></span>
