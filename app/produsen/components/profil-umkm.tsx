...
const WARNA_UTAMA = "#10B981";
const WARNA_UTAMA_GELAP = "#059669";
...
export default function ProfilUMKM({ open, onClose, onProfileUpdate }: ProfilUMKMProps) {
  ...
  const effectiveMode: Mode = wajibLengkapi ? "editUsaha" : mode;
  ...
  return (
    <div style={overlayStyle} onClick={tutupPopup}>
      <div style={modalCardStyle} onClick={(e) => e.stopPropagation()}>
          ...
          <div>
            ...
            <div style={{ padding: "0 1.5rem 0.5rem", marginTop: "-45px", textAlign: "center", position: "relative", zIndex: 2 }}>
              <div style={{ display: "inline-block", marginBottom: "0.5rem" }}>
                <div style={{ width: "90px", height: "90px", borderRadius: "50%", background: "#ECFDF5", color: WARNA_UTAMA, display: "flex", alignItems: "center", justifyContent: "center", border: "4px solid white", overflow: "hidden", boxShadow: "0 2px 8px rgba(0,0,0,0.15)" }}>
                  {subHalaman === "toko" ? (
              ...
              {subHalaman === "toko" ? (
                <>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.7rem" }}>
                    <span style={{ color: WARNA_UTAMA, background: "#ECFDF5", width: "32px", height: "32px", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}><IconMapPin /></span>
                    <div>
                  ...
                  <button onClick={() => setMode("editUsaha")} style={{ marginTop: "0.5rem", padding: "0.6rem", borderRadius: "8px", border: "none", background: WARNA_UTAMA, color: "white", fontWeight: 600, cursor: "pointer", fontSize: "0.88rem" }}>Edit Profil Usaha</button>
                </>
              ) : (
                <>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.7rem" }}>
                    <span style={{ color: WARNA_UTAMA_GELAP, background: "#ECFDF5", width: "32px", height: "32px", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}><IconPhone /></span>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "0.7rem" }}>
                    <span style={{ color: WARNA_UTAMA_GELAP, background: "#ECFDF5", width: "32px", height: "32px", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}><IconMail /></span>
        ...
        {effectiveMode === "editUsaha" && (
          <form onSubmit={handleUsahaSubmit} style={{ display: "flex", flexDirection: "column", gap: "0.8rem", padding: "1.25rem" }}>
            <div style={{ fontWeight: 700, color: "#1E293B", fontSize: "1rem", borderBottom: "1px solid #F1F5F9", paddingBottom: "0.5rem" }}>
              {wajibLengkapi ? "Lengkapi Profil Usaha Anda" : "Edit Pengaturan Profil Usaha"}
            </div>
            {wajibLengkapi && (
              <div style={{ background: "#ECFDF5", border: "1px solid #A7F3D0", color: "#065F46", padding: "0.7rem 0.85rem", borderRadius: "8px", fontSize: "0.78rem", fontWeight: 600 }}>
                Isi data usaha di bawah ini agar fitur operasional toko anda aktif.
              </div>
            )}
            <div>
              ...
              <div onClick={() => fileUsahaRef.current?.click()} style={{ border: `1.5px dashed ${WARNA_UTAMA}`, background: "#F0FDF9", borderRadius: "10px", height: "100px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", cursor: "pointer", overflow: "hidden" }}>
                {form.fotoUsahaUrl ? <img src={form.fotoUsahaUrl} alt="Usaha" style={{ width: "100%", height: "100%", objectFit: "cover" }} /> : <span style={{ fontSize: "0.75rem", color: WARNA_UTAMA_GELAP }}>Pilih foto profil usaha anda</span>}
              </div>
