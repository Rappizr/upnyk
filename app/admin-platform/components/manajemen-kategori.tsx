...
export const metadata: Metadata = {
  title: "Kategori Usaha — PasarNusa Super Admin",
};

const dataKategori = [
  { id: "CAT-A01", nama: "Makanan & Minuman", totalItem: "1.240 UMKM", status: "Aktif" },
  { id: "CAT-A02", nama: "Kerajinan & Kriya", totalItem: "450 UMKM", status: "Aktif" },
  { id: "CAT-A03", nama: "Fashion & Tekstil", totalItem: "312 UMKM", status: "Aktif" },
];
    ...
    <div style={{ display: "flex", height: "100vh", background: "#F8FAFC", fontFamily: "sans-serif", overflow: "hidden" }}>
      <main style={{ flex: 1, padding: "2rem", overflowY: "auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2rem" }}>
          <div>
            <h1 style={{ margin: 0, fontSize: "1.75rem", fontWeight: 700, color: "#0F172A" }}>Kategori Usaha</h1>
            <p style={{ margin: "0.25rem 0 0 0", color: "#64748B", fontSize: "0.95rem" }}>Kelola segmentasi sektor bisnis dan jenis usaha UMKM.</p>
          </div>
          <button style={{ background: "#2563EB", color: "white", border: "none", padding: "0.625rem 1.25rem", borderRadius: "6px", fontWeight: 600, cursor: "pointer", fontSize: "0.9rem" }}>+ Tambah Kategori Usaha</button>
        </div>
