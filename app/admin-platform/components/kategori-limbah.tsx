...
export const metadata: Metadata = {
  title: "Kategori Limbah — PasarNusa Super Admin",
};

const dataKategori = [
  { id: "CAT-D01", nama: "Ampas Kopi Organik", totalItem: "12 Industri", status: "Aktif" },
  { id: "CAT-D02", nama: "Sekam Padi & Kulit Kayu", totalItem: "34 Industri", status: "Aktif" },
  { id: "CAT-D03", nama: "Sisa Kain Perca Katun", totalItem: "22 Industri", status: "Aktif" },
];
    ...
    <div style={{ display: "flex", height: "100vh", background: "#F8FAFC", fontFamily: "sans-serif", overflow: "hidden" }}>
      <main style={{ flex: 1, padding: "2rem", overflowY: "auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2rem" }}>
          <div>
            <h1 style={{ margin: 0, fontSize: "1.75rem", fontWeight: 700, color: "#0F172A" }}>Kategori Limbah</h1>
            <p style={{ margin: "0.25rem 0 0 0", color: "#64748B", fontSize: "0.95rem" }}>Kelola pengelompokan limbah sisa produksi untuk sirkular ekonomi.</p>
          </div>
          <button style={{ background: "#2563EB", color: "white", border: "none", padding: "0.625rem 1.25rem", borderRadius: "6px", fontWeight: 600, cursor: "pointer", fontSize: "0.9rem" }}>+ Tambah Kategori Limbah</button>
        </div>
