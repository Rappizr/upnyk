...
export const metadata: Metadata = {
  title: "Kategori Produsen & Supplier — PasarNusa Super Admin",
};

const dataKategori = [
  { id: "CAT-B01", nama: "Petani Kelompok Tani", totalItem: "140 Mitra", status: "Aktif" },
  { id: "CAT-B02", nama: "Pengepul Skala Besar", totalItem: "85 Mitra", status: "Aktif" },
  { id: "CAT-B03", nama: "Distributor Resmi Pabrik", totalItem: "93 Mitra", status: "Aktif" },
];
    ...
    <div style={{ display: "flex", height: "100vh", background: "#F8FAFC", fontFamily: "sans-serif", overflow: "hidden" }}>
      <main style={{ flex: 1, padding: "2rem", overflowY: "auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "2rem" }}>
          <div>
            <h1 style={{ margin: 0, fontSize: "1.75rem", fontWeight: 700, color: "#0F172A" }}>Kategori Produsen & Supplier</h1>
            <p style={{ margin: "0.25rem 0 0 0", color: "#64748B", fontSize: "0.95rem" }}>Kelola klasifikasi rantai pasok dari penyuplai bahan baku ekosistem.</p>
          </div>
          <button style={{ background: "#2563EB", color: "white", border: "none", padding: "0.625rem 1.25rem", borderRadius: "6px", fontWeight: 600, cursor: "pointer", fontSize: "0.9rem" }}>+ Tambah Kategori Supplier</button>
        </div>
