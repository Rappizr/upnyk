...
import { ArrowLeft, Mail, Phone, Send, CheckCircle2, ShieldAlert, HelpCircle } from "lucide-react";
    ...
    <div style={{ minHeight: "100vh", background: "#F8FAFC", fontFamily: "var(--font-sans), system-ui, sans-serif", overflowX: "hidden" }}>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        @media (max-width: 768px) {
          ...
          .contact-card div:first-child svg {
            width: 14px !important;
            height: 14px !important;
          }
          .contact-card div:last-child div:first-child {
            font-size: 0.45rem !important;
            line-height: 1.1 !important;
          }
          .contact-card div:last-child div:last-child {
          ...
          .right-form-panel div:first-child svg {
            width: 14px !important;
            height: 14px !important;
          }
          .right-form-panel div:first-child span {
            font-size: 0.65rem !important;
          }
          .form-label {
            font-size: 0.52rem !important;
          ...
          /* --- SANGAT PENTING: MELIPAT ROW INPUT MENJADI 1 KOLOM KE BAWAH AGAR TIDAK PENYEK --- */
          .form-row-mobile {
          ...
          <div className="right-form-panel" style={{ background: "#ffffff", padding: "2.5rem", borderRadius: "2rem", border: "1px solid rgba(226, 232, 240, 0.8)", boxShadow: "0 20px 40px -20px rgba(0,0,0,0.03)" }}>
            ...
            {formSubmitted ? (
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyItems: "center", textAlign: "center", padding: "3rem 1rem" }}>
                ...
                <p style={{ color: "#64748B", fontSize: "0.9rem", lineHeight: 1.6, marginTop: "0px", marginBottom: "0px" }}>
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                ...
                {/* Bagian Grid Input Form yang otomatis melipat rapi ke bawah jika di HP */}
                <div className="form-row-mobile" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                  ...
                  <div>
                    <label className="form-label" style={{ display: "block", fontSize: "0.85rem", fontWeight: 700, color: "#475569", marginBottom: "0.4rem" }}>No. HP / Kontak Terikat</label>
