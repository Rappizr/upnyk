...
import { 
  UserIcon, LocationIcon, StarIcon, CameraIcon, SaveIcon, EditIcon, DollarIcon
} from "@/components/ProductIcons";

export default function ProfilPage() {
  const [tab, setTab] = useState("biodata");
  const [name, setName] = useState("Arif Kurniawan");
  const [email, setEmail] = useState("arif.kurniawan@email.com");
          ...
          {tab === "biodata" && (
            <div className="card">
              ...
              <div className="form-group">
                ...
                <textarea className="form-input" rows={3} defaultValue="Pengusaha UMKM yang aktif mencari supplier terpercaya untuk kebutuhan bisnis kuliner." id="input-bio" style={{ resize: "vertical" }} />
              </div>
